...
<div>
	...
	<div class="menu-wrapper">
		<div class="menu-title-wrapper">
			<div class="menu-title">${news_show}</div>
		</div>
			...
			<div class="list-menu-wrapper" style="float: right;">
				<ul style="list-style-image: url(images/img.jpg); text-align: left;">
					<li style="padding-left: 15px;"><a
						href="controller?command=go_to_news_list&local=${local}">${news_list}</a><br /></li>

					<c:if test="${sessionScope.role eq 'admin'}">
						<li style="padding-left: 15px;"><a
							href="controller?command=go_to_do_action&commandsName=add&local=${local}">${add_news} </a> <br /></li>
					</c:if>
				</ul>
			</div>
			<div class="clear"></div>
