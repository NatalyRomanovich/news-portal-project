...
public final class ConnectionPool {
	...
	public void moveElementsFromQueue(BlockingQueue<Connection> queue,
			BlockingQueue<Connection> queueToRemoveConnections) {
	...
	public void closeConnection(Connection con, Statement st, ResultSet rs) throws ConnectionPoolException {
		...
		try {
			...
			LOG.log(Level.ERROR, "ResultSet is not closed");
		}

		try {
			st.close();
		} catch (SQLException e) {
			LOG.log(Level.ERROR, "Statement is not closed");
		}

		try {
			con.close();
		} catch (SQLException e) {
			LOG.log(Level.ERROR, "Connection is not return to the pool");
		}
	}
