...
public class UserDAOImpl implements UserDAO {
	...
	@Override
	public List<String> getAlreadyUsedParameters(NewUserInfo user) throws DaoException {

		try (Connection connection = ConnectionPool.getInstance().takeConnection();
				PreparedStatement ps = connection.prepareStatement(ADDING_USER)) {

			RegisrtationCheckInDB alreadyUsedParameters = new RegisrtationCheckInDB(connection, user);
			List<String> alreadyUsedParametersList = new ArrayList<String>();
