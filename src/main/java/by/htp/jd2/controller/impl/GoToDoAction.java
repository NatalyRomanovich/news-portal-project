...
public class GoToDoAction implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String urlForRedirect = "controller?command=go_to_do_action&" + AttributsKey.NEWS_COMMANDS_NAME + "=" + action;
		...
		case (EDIT_NEWS):
			try {
				...
				urlForRedirect = urlForRedirect + "&" + NewsParameter.JSP_ID_NEWS + "=" + id;
				getSession.setAttribute(AttributsKey.URL, urlForRedirect);
				news = newsService.findById(Integer.parseInt(id));
				editNews(getSession, request, response, news, action);
