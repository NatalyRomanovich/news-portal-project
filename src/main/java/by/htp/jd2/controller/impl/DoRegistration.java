	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {		    	
	    	if (service.registration(userData)) {
				...
				request.removeAttribute(AttributsKey.REG_USER);
			}
			else {
				...
				//response.sendRedirect("controller?command=go_to_base_page&registrationError =Invalid data entered&show_news=not_show");					
			}			
